...
import {EverFaultCard} from "../../components/extras/EverFaultCard";
...
export default function CompleteRegistrationPage() {
    ...
    return (
        <FrontPageLayout>
            <EverFaultCard
                className="relative flex min-h-[calc(100vh-4rem)] w-full place-items-center justify-center bg-gradient-to-br from-cyan-100 via-white to-pink-200">

                    <div
                        className="flex w-[40vw] min-w-[500px] flex-col gap-10 rounded-lg bg-white p-12 shadow-md border border-gray-300">
