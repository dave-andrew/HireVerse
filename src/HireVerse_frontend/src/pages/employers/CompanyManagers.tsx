...
export default function CompanyManagers() {
    ...
    return (
        <>
            <div className="absolute bg-[url(/backgrounds/liquid-cheese.svg)] bg-cover opacity-50 w-full h-96 z-0">
            </div>
            <ManagementPageLayout>
                <div className="px-14 py-8 flex flex-col gap-16 z-10">
                ...
                <Modal handleClose={toggleModal} show={isModalShown} modalTitle={"Invite Manager"}>
                    ...
                    <div className="flex justify-center w-full gap-4 items-center ">
                        ...
                        <label className="font-medium text-gray-900 dark:text-gray-300 w-[80%]">
                            ...
                            You <b className="text-red-600 inline"> cannot </b>undo this action once the user has
                            accepted
                            their invites.
                        </label>
                    </div>
