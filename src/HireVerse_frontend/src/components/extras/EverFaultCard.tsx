...
export const EverFaultCard = ({
    ...
    return (
        <div
            className={cn(
                "p-0.5 bg-transparent  flex items-center justify-center h-full w-full relative",
                className
            )}
        >
            <div
                onMouseMove={onMouseMove}
                className="group/card  min-h-[calc(100vh-4.4rem)] w-full relative overflow-hidden bg-transparent flex items-center justify-center h-full"
            >
                <CardPattern
                    mouseX={mouseX}
                    mouseY={mouseY}
