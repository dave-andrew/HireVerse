...
import { getUserObjectByEmail } from "../../datas/queries/jobQueries";
...
export default function InviteManagerModal({
    ...
    const createInvitation = (e: FormEvent) => {
        e.preventDefault();
        if (!checked) {
            toast.warn("You must agree to proceed.", defaultToastOptions);
            return;
        }
        ...
        mutation.mutate(
            {
                invitee: userData.internet_identity,
        ...
        <Modal
            ...
            <div className="flex w-full items-center justify-center gap-4 ">
                ...
                <label className="w-[80%] font-medium text-gray-900">
                    <b>
                        I took all the responsibilities of introducing a new
                        manager to the company.{" "}
                    </b>
                    You <b className="inline text-red-600"> cannot </b>
                    undo this action once the user has accepted their invites.
                </label>
            </div>
