...
export default function Section2({ parentRef }: { parentRef: React.MutableRefObject<HTMLElement | null> }) {
    ...
    return (
        <div
            className={`grid z-10 grid-cols-1 xl:grid-cols-2 place-items-center justify-center gap-16 py-32 px-[10vh] md:px-[20vh] transition-all ease-in-out duration-1000 min-h-[1000px] `}>
            <iframe
