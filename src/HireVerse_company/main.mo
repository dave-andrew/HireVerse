...
actor Company {
    ...
    public shared func createCompany(name : Text, founded_year : Nat, country : Text, location : Text, image : Blob, linkedin : Text, user: Principal) : async Company {
    ...
    public shared func displayAllCompany() : async [Company] {
